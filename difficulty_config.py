...
DIFFICULTY_SETTINGS = {
    "easy": {
        ...
        DifficultySettings.HEALING_POTION_PROBABILITY: 0.2,
        DifficultySettings.VISION_POTION_PROBABILITY: 0.2,
        DifficultySettings.SUGGESTION_POTION_PROBABILITY: 0.2,
        DifficultySettings.MAGIC_KEY_PROBABILITY: 0.2,
        DifficultySettings.LOCKED_DOOR_PROBABILITY: 0.25,
        DifficultySettings.MIN_HEALING_POTION_VALUE: 5,
        DifficultySettings.MAX_HEALING_POTION_VALUE: 20,
    ...
    "medium": {
        DifficultySettings.PIT_PROBABILITY: 0.25,
        ...
        DifficultySettings.LOCKED_DOOR_PROBABILITY: 0.35,
        DifficultySettings.MIN_HEALING_POTION_VALUE: 1,
        DifficultySettings.MAX_HEALING_POTION_VALUE: 15,
        DifficultySettings.MIN_PIT_DAMAGE: 5,
        DifficultySettings.MAX_PIT_DAMAGE: 25,
        DifficultySettings.MIN_ENTRANCE_EXIT_MANHATTAN_DISTANCE: 6,
    },
    "hard": {
        DifficultySettings.PIT_PROBABILITY: 0.3,
        DifficultySettings.HEALING_POTION_PROBABILITY: 0.1,
        DifficultySettings.VISION_POTION_PROBABILITY: 0.1,
        DifficultySettings.SUGGESTION_POTION_PROBABILITY: 0.1,
        DifficultySettings.MAGIC_KEY_PROBABILITY: 0.1,
        DifficultySettings.LOCKED_DOOR_PROBABILITY: 0.5,
        DifficultySettings.MIN_HEALING_POTION_VALUE: 1,
        DifficultySettings.MAX_HEALING_POTION_VALUE: 10,
        DifficultySettings.MIN_PIT_DAMAGE: 5,
        DifficultySettings.MAX_PIT_DAMAGE: 30,
